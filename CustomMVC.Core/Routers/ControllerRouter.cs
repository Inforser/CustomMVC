namespace CustomMVC.Core.Routers
{
    using System;
    ...
    using CustomMVC.Core.Attributes.Methods;
    using CustomMVC.Core.Controllers;
    using CustomMVC.Core.Extensions;
    ...
    public class ControllerRouter : IHandleable
    {
        ...
        private void InitControllerName()
        {
            this.controllerName = this.controllerAction[this.controllerAction.Length - 2].ToUpperFirst() +
                                  MvcContext.Current.ContollersSuffix;
        }
